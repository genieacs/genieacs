...
export function updateDeviceTags(deviceId, tags) {
  return new Promise((resolve, reject) => {
    const add = [];
    const pull = [];
...
function putResource(resource, id, object) {
  return new Promise((resolve, reject) => {
    getClient()
      .then(client => {
        const collection = client
...
export function putPreset(id, object) {
...
export function putProvision(id, object) {
  return putResource("provisions", id, object);
}

export function deleteProvision(id) {
  return deleteResource("provisions", id);
}

export function putVirtualParameter(id, object) {
  return putResource("virtualParameters", id, object);
}

export function deleteVirtualParameter(id) {
...
export function putFile(filename, metadata, contentStream) {
  return new Promise((resolve, reject) => {
    getClient()
      .then(client => {
