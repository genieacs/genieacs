...
export function evaluate(exp, obj, now, cb) {
...
export function not(exp) {
  if (isArray(exp) && exp[0] === "NOT") return exp[1];
  return ["NOT", exp];
}

export function subset(exp1, exp2) {
...
export function likePatternToRegExp(pat, esc = "", flags = "") {
  const convChars = {
    "-": "\\-",
    "/": "\\/",
    "\\": "\\/",
...
export function extractParams(exp) {
