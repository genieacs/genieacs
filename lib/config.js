...
const configFile = JSON.parse(
  readFileSync(resolve(allConfig.CONFIG_DIR, "config.json"))
);
...
export function get(optionName, deviceId) {
...
export function getDefault(optionName) {
...
try {
  auth = require(resolve(allConfig.CONFIG_DIR, "auth.js"));
} catch (error) {
  // No auth.js exists
}
