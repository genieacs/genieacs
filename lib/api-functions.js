...
export function connectionRequest(deviceId, callback) {
...
export function watchTask(deviceId, taskId, timeout, callback) {
  setTimeout(() => {
...
export function insertTasks(tasks, callback) {
