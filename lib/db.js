...
export function fetchDevice(id, timestamp, patterns, callback) {
...
export function getFaults(deviceId, callback) {
  faultsCollection
...
export function saveFault(deviceId, channel, fault, callback) {
...
export function deleteFault(deviceId, channel, callback) {
  faultsCollection.deleteOne({ _id: `${deviceId}:${channel}` }, callback);
}

export function getDueTasks(deviceId, timestamp, callback) {
...
export function clearTasks(deviceId, taskIds, callback) {
...
export function getOperations(deviceId, callback) {
  operationsCollection
    .find({ _id: { $regex: `^${escapeRegExp(deviceId)}\\:` } })
    .toArray((err, res) => {
      if (err) return void callback(err);
...
export function saveOperation(deviceId, commandKey, operation, callback) {
...
export function deleteOperation(deviceId, commandKey, callback) {
...
export function getPresets(callback) {
  presetsCollection.find().toArray(callback);
}

export function getObjects(callback) {
...
export function getVirtualParameters(callback) {
