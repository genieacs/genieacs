  ...
  if (details.rpc) {
    if (details.rpc.acsRequest) {
      ...
      if (details.rpc.cpeRequest.name === "Inform") {
        ...
        details.cpeRequestName = details.rpc.cpeRequest.type;
      ...
      details.acsRequestId = details.rpc.id;
      details.cpeFaultCode = details.rpc.cpeFault.faultCode;
      details.cpeFaultString = details.rpc.cpeFault.faultString;
    }
    delete details.rpc;
  }
