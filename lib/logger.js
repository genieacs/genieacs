...
export function init(service, version) {
...
export function accessLog(details) {
  details.timestamp = new Date().toISOString();
...
export function accessInfo(details) {
  details.severity = "info";
  accessLog(details);
}

export function accessWarn(details) {
  details.severity = "warn";
  accessLog(details);
}

export function accessError(details) {
  details.severity = "error";
  accessLog(details);
}
